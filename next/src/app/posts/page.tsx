...
async function fetchHighLoadData(): Promise<LoaderData> {
  const startTime = performance.now();

  console.log("Next.js - Starting optimized data fetching...");
  ...
  console.log(`Next.js - Optimized data fetching completed:`);
...
export const metadata = {
  title: "Posts - Next.js",
  description: "Posts page with Next.js App Router",
};
...
export default async function Posts() {
  ...
  return (
    <div className="p-5 font-sans text-gray-800">
      <h1>Posts (Next.js) - Optimized Version</h1>
      ...
      <div className="grid gap-5 mt-5">
        {posts.slice(0, 15).map((post: Post) => {
